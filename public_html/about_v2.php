...
<section class="about">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <a href="shop_v2.php" class="btn">shop now</a>
        </div>
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <a href="contact_v2.php" class="btn">contact us</a>
        </div>
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <a href="data_privacy_v4.php" class="btn">data privacy</a>
        </div>
...
<section class="about">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <a href="login.php" class="btn">update profile</a>
        </div>
    ...
    <div class="content">
        ...
        <a href="login.php" class="btn">wishlist</a>
    </div>
    ...
    <div class="content">
        ...
        <a href="login.php" class="btn">orders</a>
    </div>
